...
| 우선순위 | 작업 | 상태 |
|---|---|---|
| 1 | `server/gateway` — gRPC ↔ ROS2 변환 실제 구현 | 스텁 |
| 2 | `server/slam` — MASt3R-SLAM + RoMa 어댑터 구현 | 스텁 |
| 3 | Docker 이미지 실제 빌드 & 테스트 (slam 컨테이너) | 미실행 |
| 4 | Flutter gRPC 연동 — Rust Core 센서 스트리밍 | 미착수 |
